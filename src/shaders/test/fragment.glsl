...
void main()
{
    ...
    // float barY = step(0.5, mod(vUv.y * 10.0, 1.0));
    ...
    // Pattern 15
    // float barX = step(0.5, mod(vUv.x * 10.0, 1.0));
    // barX *= step(0.8, mod(vUv.y * 10.0 + 0.15, 1.0));
    // float barY = step(0.5, mod(vUv.y * 10.0, 1.0));
    // barY *= step(0.8, mod(vUv.x * 10.0 + 0.15, 1.0));
    // float strength = barX + barY;
    // gl_FragColor = vec4(vec3(strength), 1.0);
    ...
    // Pattern 17
    // float strength = min(abs(vUv.x - 0.5), abs(vUv.y - 0.5)) + 0.025;
    // gl_FragColor = vec4(vec3(strength), 1.0);

    // Pattern 18
    // float strength = max(abs(vUv.x - 0.5), abs(vUv.y - 0.5)) + 0.025;
    // gl_FragColor = vec4(vec3(strength), 1.0);
    ...
    // );
    // float strength = 1.0 - step(0.01, abs(distance(lightUv, vec2(0.5)) - 0.25));
    // gl_FragColor = vec4(vec3(strength), 1.0);
